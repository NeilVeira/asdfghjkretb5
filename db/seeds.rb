...
tournaments_list = [
	["tourname1","description1", true, "extrafeatures1",GolfCourse.first.id, DateTime.new(2016,11,9) ],
	...
	["tourname6","desc6", false, "extraf6",GolfCourse.third.id,  DateTime.new(2019,1,1)],
	["tourname7","desc7", false, "extraf7",GolfCourse.fourth.id,  DateTime.new(2016,11,30)],
]
